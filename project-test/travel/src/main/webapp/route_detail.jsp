...
<div class="wrap">
    <div class="bread_box">
        ...
        <span> &gt;</span>
        <a href="${pageContext.request.contextPath}/routeServlet?action=findByPage&cid=${route.category.cid}">${route.category.cname}</a><span> &gt;</span>
    ...
    $(document).ready(function() {
        ...
        $("#addCart").click(function () {
            ...
            if (${empty currentUser}) {
                ...
                location.href="${pageContext.request.contextPath}/cartServlet?action=addCart&num="+num+"&rid=${route.rid}";
            }
        });
    });
